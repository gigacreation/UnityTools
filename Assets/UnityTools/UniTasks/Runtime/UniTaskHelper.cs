...
namespace GigaCreation.Tools.UniTasks
{
    public static class UniTaskHelper
    {
        public static async UniTask SkippableDelay(
            int millisecondsDelay, Func<bool> condToSkip, bool ignoreTimeScale = false,
            PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken ct = default)
        {
        ...
        public static async UniTask SkippableDelay(
            TimeSpan delayTimeSpan, Func<bool> condToSkip, bool ignoreTimeScale = false,
            PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken ct = default)
        {
        ...
        public static async UniTask SkippableTween(
            Tween tween, Func<bool> condToSkip,
